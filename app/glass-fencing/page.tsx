...
export const metadata: Metadata = {
  title: "Glass Fencing Hardware Canada | 2205 Spigots",
  description:
    "Source corrosion-resistant glass fencing hardware in Canada for pool, balcony, and perimeter fencing projects."
};

export default function GlassFencingPage() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-10 md:px-8 md:py-14">
      <h1 className="text-[28px] font-semibold leading-tight md:text-4xl">Glass Fencing</h1>
      <p className="mt-4 max-w-3xl text-sm leading-6 text-neutral-700 md:text-base md:leading-7">
        Build safer, cleaner outdoor boundaries with professional glass fencing hardware designed for 10-12mm tempered
        glass and long-term exterior performance.
      </p>
